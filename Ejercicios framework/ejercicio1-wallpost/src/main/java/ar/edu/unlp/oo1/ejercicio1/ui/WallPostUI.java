...
public class WallPostUI {
  ...
  private void setUpWindow() {
	Logger.getLogger("app").log(Level.INFO, "Inicio la app");
  ...
  private void wireComponents() {
    this.like.addActionListener( e -> {
      Logger.getLogger("app").log(Level.INFO, "Se interactua con like envidiar-atributos");
      this.wallPost.like();
      this.likesLabel.setText(String.valueOf(this.wallPost.getLikes()));
    });
    
    this.dislike.addActionListener( e -> {
      Logger.getLogger("app").log(Level.INFO, "Se interactua con dislike");
    ...
    this.textArea.getDocument().addDocumentListener(new DocumentListener() {
      ...
      public void removeUpdate(DocumentEvent e) {
        Logger.getLogger("app").log(Level.INFO, "Se borra el post");
        wallPost.setText(textArea.getText());
      }
      
      @Override
      public void insertUpdate(DocumentEvent e) {
        Logger.getLogger("app").log(Level.INFO, "Se agrega una digito");
        wallPost.setText(textArea.getText());
      }
      
      @Override
      public void changedUpdate(DocumentEvent e) {
    	Logger.getLogger("app").log(Level.INFO, "Se cambia un post");
        wallPost.setText(textArea.getText());
      }
    });
